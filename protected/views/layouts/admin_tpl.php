...
<!--FONT AWESOME-->
<!--<link href="//netdna.bootstrapcdn.com/font-awesome/4.0.7/css/font-awesome.min.css" rel="stylesheet">-->
...
<!-- <link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/jquery.minicolors.css" rel="stylesheet" type="text/css" media="all" > -->
<link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/bootstrap-colorpicker.css" rel="stylesheet">
<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/hierarchy-select.min.css">
<?php if(Yii::app()->language == 'ar'): ?>
<link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/admin_rtl.css" rel="stylesheet" />
<?php endif ?>
...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/jquery.minicolors.min.js"></script>   
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/bootstrap-colorpicker.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/hierarchy-select.js"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/js/index.js"></script>
