...
$lang["Signup"]              ="تسجيل";
$lang["Sign In"]             ="دخول";
$lang["Restaurant Signup"]   ="تسجيل المتجر";
$lang['Login Successful']    ='تم الدخول بنجاح';
$lang['Either username or password is invalid.']   = "اي من اسم المستخدم أو كلمة المرور غير صحيح";
$lang["username & password is required"]           = "اسم المستخدم وكلمة المرور مطلوبين";
$lang["Sorry you input email address that is already registered in our records."] = "عفوا البريد الالكتروني هذا مسجل لدينا بالفعل";
$lang["ERROR: Missing package id"]                 = "";
$lang["ERROR: Package information not found"]      = "";
$lang["Merchant Username is already been taken"]   = "اسم المستخدم للمتجر هذا محجوز لدينا بالفعل لمستخدم آخر";
$lang["Merchant updated."]                         = "تم تحديث المتجر";
$lang["ERROR: cannot update"]                      = "خطأ:: لا نستيطع التحديث";
$lang["Edit"]                                      = "تعديل";
$lang["Delete"]                                    = "جذف";
$lang["Missing parameters"]                        = "";
$lang["Successfully remove."]                      = "تم الحذف بنجاح";
$lang["ERROR: cannot execute query."]              = "";
$lang["Successfully deleted."]                     = "عملية حذف ناجحة";
$lang["ERROR: cannot execute query."] = "";
$lang["Login Successful"] = "تم الدخول بنجاج";
$lang["Login Failed. You account status is "] = "تعذر الدخول. حالة حسابك  ";
$lang["Either username or password is invalid."] = "أي من اسم المستخدم أو كلمة المرور غير صحيح";
$lang["Cannot create upload folder. Please create the upload folder manually on your rood directory with 777 permission."] = "";
$lang["Upload Completed"] = "تم اكتمال الرفع";
$lang["File is empty"] = "الملف فارغ";
$lang["Category updated."] = "تم تحديث التصنيف";
$lang["Category added."] = "تم اضافة التصنيف";
...
$lang["Size updated."] = "";
$lang["Size added."] = "";
$lang["Cooking Ref. updated."] = "تم تحديث دليل المنتج";
$lang["Cooking Ref. added."] = "تم اضافة دليل المنتج";
$lang["Sorry but you reach the limit of adding food item. Please upgrade your membership"] = "عفوا لقد وصلت للحد الأفصى لإضافة المنتجات. رجاء قم بترقية الاشتراك الخاص بك";
$lang["Item updated."] = "";
$lang["Item added."] = "";
$lang["Settings saved."] = "";
$lang["Sort saved."] = "";
$lang["Cuisine"] = "العلامات التجارية";
$lang["Distance"] = "";
$lang["miles"] = "";
$lang["Delivery Est"] = "";
...
$lang["Sorry but we cannot find what you are looking for."] = "عفوا لا نستطيع إيجاد ما تبحث عنه.";
$lang["Item id is required"] = "";
$lang["Registration successful"] = "تم التسجيل بنجاج";
$lang["Something went wrong during processing your request. Please try again later."] = "";
$lang["Sorry but your email address already exist in our records."] = "عفوا البريد الإلكتروني هذا مسجل لدينا بالفعل";
...
$lang["Order History"] = "تاريخ الطلبات";
$lang["Credit Cards"] = "";
$lang["Logout"] = "خروج";
...
$lang["Number of Food Item Can Add must be greate than 1"] = "عدد المنتجات المضافة لابد أن يكون أكثر من 1 ";
...
$lang["Merchant is already activated."] = "المتجر مفعل بالفعل";
$lang["Merchant Successfully activated."] = "تم تفعيل المتجر بنجاح";
$lang["Invalid Activation code."] = "رمز تأكيدي غير صحيح";
...
$lang["Please select payment option"] = "رجاء قم باختيار وسيلة دفع";
$lang["ERROR: Cannot get package information"] = "";
$lang["Change Order Status"] = "تغيير حالةالطلب";
$lang["Error: Order not found"] = "";
...
$lang["Cuisine updated."] = "تم تحديث العلامة التجارية";
$lang["Successful Merchant is now published."] = "";
$lang["ERROR: cannot update status"] = "";
$lang["Profile Updated."] = "تم تحديث الملف الشخصي";
...
$lang["Email is required"] = "البريد الإلكتروني مطلوب";
...
$lang["Map"] = "الخريطة";
$lang["Photos"] = "";
$lang["This restaurant has not published their menu yet."] = "المتجر لم يقم بنشر قائمة منتجاته حتى الآن";
$lang["Your Order"] = "";
...
$lang["Usage"] = "";
$lang["Restaurant name"] = "اسم المتجر";
$lang["Restaurant phone"] = "تليفون المتجر";
$lang["Contact name"] = "اسم المسئول";
$lang["Contact phone"] = "تليفون";
$lang["Contact email"] = "البريد الإلكتروني";
$lang["Important: Please enter your correct email. we will sent an activation code to your email"] = "برجاء قم بكتابة بريد إلكتروني صحيح، سنقوم بإرسال كود تفعيل علي هذا البريد";
$lang["Street address"] = "اسم الشارع";
$lang["City"] = "المدينة";
$lang["Post code/Zip code"] = "الرقم البريدي";
$lang["State/Region"] = "الولاية";
$lang["Services Pick Up or Delivery?"] = "خدمة التوصيل";
$lang["Login Information"] = "معلومات الدخول";
$lang["Username"] = "اسم المتسخدم";
$lang["Next"] = "التالي";
...
$lang["Minimum"] = "";
$lang["Distance"] = "";
$lang["Payment to merchant"] = "الدفع الي التاجر";
$lang["Stripe payment is not properly configured on merchant portal."] = "";
$lang["Pay using Stripe Payment"] = "";
$lang["Add New"] = "إضافة جديد";
$lang["Sort"] = "نرنيب";
$lang["AddOn Name"] = "اسم الاضافة";
$lang["Description"] = "الوصف";
$lang["Status"] = "الحالة";
$lang["Date"] = "التاريخ";
$lang["Drag the item below to sort"] = "";
$lang["No results"] = "لا يوجد نتائج";
$lang["AddOn Item Name"] = "اسم الاضافة";
$lang["AddOn Category"] = "قسم الإضافات";
$lang["AddOn Item"] = "عنصر الاضافة";
...
$lang["Food Category Name"] = "اسم قسم المنتجات";
$lang["Cooking Ref. name"] = "اسم دليل المنتج";
$lang["Ref#"] = "";
$lang["Item"] = "العنصر";
$lang["TransType"] = "";
$lang["Total"] = "اﻹجمالي";
$lang["Tax"] = "الضريبة";
$lang["Total W/Tax"] = "";
$lang["Food Item Name"] = "اسم المنتج";
$lang["AddOn"] = "";
$lang["Food Category"] = "تصنيف المنتج";
$lang["Categories"] = "الفئات";
$lang["Sub Categories"] = "الفئات الفرعية";
$lang["Brands"] = "العلامات التجارية";
$lang["Size"] = "المقاس";
$lang["Please add different size in order to add price."] = "";
$lang["Discount (numeric value)"] = "";
$lang["Cooking Reference"] = "أدلة المنتجات";
$lang["Enter Verification Code & Your New Password"] = "";
$lang["Code"] = "";
$lang["Latitude"] = "";
$lang["Longitude"] = "";
$lang["Package Name"] = "اسم الباقة";
$lang["Package Price"] = "سعر الباقة";
$lang["Membership Expired On"] = "العضوية ستنتهي في";
$lang["Set Default Order Status:"] = "الوضع الافتراضي للطلبات";
$lang["Default Status"] = "حالة المتجر الافتراضية";
$lang["The default order status when the client place order on front end."] = "الحالة الافتراضية للطلب عندما يتم الطلب في الموقع.";
$lang["ID"] = "";
$lang["Enabled Paypal"] = "";
$lang["Mode"] = "";
$lang["Sandbox"] = "";
...
$lang["Start Date"] = "";
$lang["End Date"] = "";
$lang["Order Status"] = "حالة الطلبات";
$lang["Export"] = "";
$lang["Item ID"] = "";
$lang["Size"] = "";
$lang["Total Qty"] = "";
...
$lang["Display Google Map"] = "إظهار خريطة جوجل";
$lang["Cuisine Name"] = "";
$lang["Date Created"] = "";
$lang["Currency Code"] = "";
...
$lang["Slug"] = "";
$lang["Page Title"] = "";
$lang["MerchantID"] = "رقم التاجر التسلسلي";
...
$lang["Membership"] = "";
$lang["Featured"] = "";
$lang["Payment History"] = "قائمة الدفعات";
$lang["Check this if you want this merchant featured on homepage"] = "";
$lang["Amount"] = "";
$lang["Expired On"] = "";
$lang["Transaction Date"] = "";
$lang["No Payment records"] = "لا يوجد اي سجل دفعات";
$lang["New Merchant Payment List For Today"] = "قائمة الدفع الجديدة الخاصة بالتاجر اليوم";
$lang["TransID"] = "";
$lang["Enter language Name"] = "";
$lang["Contact"] = "";
$lang["Title"] = "";
...
$lang["Number of Food Item Can Add"] = "عدد المنتجات التي يمكن إضافتها";
...
$lang["Remove image"] = "";
$lang["Merchant Registration"] = "تسجيل التجار";
...
$lang["Order Delivery Food Online From Local Restaurants"] = "اطلب توصيل المنتجات من المتاجر المحلية";
$lang["Search As Address"] = "";
$lang["User will search restaurant using address (default)"] = "المستخدمون سوف يقومون بالبحث باستخدام عنوان المتجر(افتراضي)";
$lang["Search As PostCode"] = "";
$lang["User will search restaurant using postcode/zipcode"] = "المستخدمون سوف يقومون بابحث باستخدام الرقم البريدي للمتجر";
...
$lang["No data available in table"] = "لايوجد بيانات متاحة للعرض ";
...
$lang["Please rate the restaurant before submitting your review!"] = "رجاء قم بتقييم المتجر قبل ارسال مراجعتك!";
...
$lang["Merchant Info"] = "معلومات المتجر";
$lang["Settings"] = "الإعدادات";
$lang["Food Item"] = "المنتج";
$lang["AddOn Item"] = "اضافة عنصر";
$lang["Receipt Settings"] = "";
$lang["Payment Gateway"] = "بوابات الدفع الالكتروني";
$lang["Reports"] = "التقارير";
$lang["Sales Report"] = "";
$lang["Sales Summary Report"] = "";
$lang["Social Settings"] = " إعدادات مواقع التواصل ";
$lang["Alert Notification"] = "";
$lang["Merchant List"] = "قائمة التجار";
$lang["Sponsored Listing"] = "ادارة الاعلانات الممولة";
$lang["Packages"] = "الباقات";
$lang["Custom Page"] = "الصفحات الثابتة";
$lang["Contact Settings"] = "اعدادات معلومات التواصل";
$lang["Manage Currency"] = " إدارة العملات";
$lang["Manage Language"] = "إدارة اللغات";
$lang["SEO"] = "تطوير محرك البحث";
$lang["SMS"] = "الرسائل النصية القصيرة";
$lang["SMS Settings"] = "اعدادات الرسائل النصية";
$lang["SMS Package"] = "باقات الـ SMS";
$lang["Merchant Payment"] = "عمليات دفع التاجر";
$lang["User List"] = "قائمة المستخدمين";
$lang["Home"] = "";
$lang["Contact"] = "";
...
$lang["Search by name"] ="";
$lang["Pick Merchant"] ="اختر التاجر";
$lang["Search"] ="";
$lang["Create your order"] ="";
$lang["ADMIN"] ="مدير الموقع";
$lang["Merchant"] ="تاجر";
$lang["Published Merchant"] ="نشر التاجر";
$lang["Check this box to published your merchant, if this box is not check your merchant will not show on search result."] ="قم بتفعيل متجرك ليتم نشره، إذا لم تقم بتفعيل هذا الاختيار لن يتم ظهورة متجر في نتائج البحث.";
...
$lang["Activation"] ="";
$lang["Select Package"] ="";
$lang["Merchant information"] ="معلومات المتجر";
...
$lang["New Merchant Registration List For Today"] ="قائمة المتاجر المسجلة اليوم";
$lang["Merchant Payment History"] ="سجل دفعات المتجر";
$lang["Merchant Add"] ="أضافة متجر";
$lang["Packages Sort"] ="";
$lang["Packages add"] ="";
$lang["Paypal Settings"] ="";
$lang["Sponsored Merchant Add"] ="أضافة تاجر معلن";
$lang["Sponsored Merchant List"] ="قائمة التجار المعلنين";
$lang["Currency Add"] ="أضافة عملة";
$lang["Currency List"] ="قائمة العملات";
$lang["Cuisine Add"] ="أضافة علامة تجارية";
$lang["Cuisine Sort"] ="ترتيب العلامات التجارية";
$lang["Cuisine List"] ="قائمة العلامات التجارية";
$lang["Order Status Add"] ="";
$lang["Order Status List"] ="";
$lang["Ratings Add"] ="";
$lang["Profile Settings"] ="";
$lang["User Add"] ="أضافة مستخدم";
$lang["Custom page Add"] ="";
$lang["Assign Page"] ="";
$lang["Custom page List"] ="";
$lang["Manage Language Add"] ="";
$lang["Manage Language Settings"] ="ادارة اعدادات اللغة";
$lang["SMS Package Add"] ="إضافة باقة SMS";
$lang["New Order List For Today"] ="قائمة الطلبات الجديدة اليوم";
$lang["View"] ="عرض";
$lang["Alert Settings"] ="إعدادات التنبيهات";
$lang["SMS"] ="";
$lang["SMS Purchase Credits"] ="";
$lang["SMS Credits"] ="";
$lang["Take this package"] ="احص علي هذه الباقة";
...
$lang["Please select Payment gateway."] ="برجاء اختر بوابة دفع";
$lang["Please select package"] ="برجاء اختر باقة";
$lang["Please wait while we redirect you"] ="برجاء الانتظار سنقوم بتحويلك";
$lang["Choose Payment option"] ="اختر طريقة دفع";
$lang["Purchase using Offline Credit Card"] ="قم بالشراء باستخدام بطاقة دفع إلكتروني";
...
$lang["Pay"] ="";
$lang["Payment for Food Order -"] ="الدفع لطلب المنتج -";
...
$lang['Table Booking']= 'الحجوزات';
$lang['Guest Name']= 'اسم المريض';
$lang['Date Booking']= 'تاريخ الحجز';
$lang['No. Of guest']= 'رقم المريض';
$lang['BookingID']= 'رقم الحجز';
$lang['Booking updated.']= '';
$lang['Booking added.']= '';
$lang['Share this restaurant']= 'مشاركة هذا المتجر';
$lang['Come and order at']= '';
$lang['This restaurant is closed now. Please check the opening times.']= 'المتجر مغلق الآن رجاء قم بمراجعة ساعات عمل المتجر.';
$lang['Order food at']= 'طلب الطعام في';
$lang['Disabled restaurant share']= 'أيقاف مشاركة المتجر';
$lang['Prev']= '';
$lang['Today']= '';
$lang['January']= '';
$lang['February']= '';
...
$lang['Incoming orders from merchant for today']= 'الطلبات الواردة من التجار اليوم';
$lang['Merchant Sales Report']= 'تقارير بيع التاجر';
...
$lang['Receive Bank Deposit']= 'تلقي الودائع البنكية';
...
$lang['Find restaurant by name']= 'ابحث عن المتجر باستخدام الاسم';
$lang['Find by street name']='قم بالبحث باستخدام اسم الشارع';
$lang['Find restaurant by cuisine']= 'ابحث عن المتجر باستخدام العلامات التجارية';
$lang['Search by address']= 'ابحث بالعنوان';
$lang['Restaurant name']= 'اسم المتجر';
$lang['Street name']= 'اسم الشارع';
$lang['Cuisine']= 'العلامة التجارية';
$lang['Enter Cuisine']= 'ادخل العلامة التجارية';
$lang['Enabled advance search']= 'تفعيل البحث المتقدم';
...
$lang['View Website']='مشاهدة الموقع';
...
$lang['Payment Gateway Settings']=' إعدادات بوابات الدفع اﻹلكتروني';
...
$lang['AutoLogin']='';
$lang['Food']='منتج';
$lang['Find restaurant by food']='قم بالبحث عن المتجر بالمنتج';
$lang['Enter Food Name']='ادخل اسم المنتج';
$lang['Enabled Maps']='تفعيل الخريطة';
...
$lang['Food Item added to cart']='تم اضافة المنتج إلي السلة';
$lang['Cart updated']='';
...
$lang['No food item']='لا يوجد منتجات';
$lang['Use Unicode']='';
...
$lang['Commission Settings']='اعدادات العملات';
...
$lang['Merchant Commission details']='تفاصيل عمولات التجار';
$lang['Commission price']='قيمة العمولة';
$lang['Total Price']='';
$lang['Total Commission']='اجمالي العمولات';
...
$lang['Commission last 30 days']='العمولات اخر 30 يوم';
...
$lang['Booking Summary Report']='ملخص تقارير الحجوزات';
$lang['Total Guests Booked']='';
$lang['Total Approved']='';
$lang['Total Denied']='';
$lang['Total Pending']='';
$lang['Fax Logs']='سجلات الفاكس';
$lang['Fax Payment Transaction']='عمليات دفع الفاكس';
$lang['All Merchant']='';
$lang['Start Date']='';
$lang['End Date']='';
...
$lang['Pick Up or Delivery']='خدمة التوصيل';
...
$lang['Disabled single food item auto add to cart']='أيقاف إمكانية أضافة منتج واحد للسلة';

/*version 2.1.1*/
$lang['Holiday Close Message']='';
$lang['Restaurant Information']='معلومات المتجر';
$lang['Percentage']='';
$lang['Unselect All']='';
...
$lang['0 restaurant found']='لم يتم العثور علي أي متجر';
$lang['Search']='بحث';
$lang['View Restaurant by map']='مشاهدة المتجر باستخدام الخريطة';
$lang['Reset Map']='';
...
$lang['Miles']='';
$lang['Dishes']='الشركات المصنعة';
$lang['Products']='المنتجات';
$lang['Dish Name']='اسم الشركة المصنعة';
$lang['Dish name is required']='اسم الشركة مطلوب';
$lang['Icon is required']='';
$lang['Dish updated']='تحديث الشركة';
$lang['Dish Name']='اسم الشركة المصنعة';
$lang['Dish']='';
$lang['Cart Options']='';
...
$lang['this will add a field on food item and category for multiple language']='هذا سوف يقوم بإضافة حقل للمنتج والقسم في لغات متعددة';
$lang['English']='';
$lang['Top']='';
...
$lang['Food Item Options']='خيارات المنتج';
...
$lang['View Restaurant by map options']='مشاهدة المتجر باستخدام خيارات الخريطة';
...
$lang['Click here to update your database']='اضغط هنا لتحديث قاعده بياناتك';
...
$lang['Disabled food gallery']='أيقاف ألبوم المنتج';
...
$lang['Enabled Paypal']='';
$lang['Get your favourite food in 4 simple steps']='أحصل عي منتجك في 4 خطوات بسيطة';
$lang['How it works']='';
$lang['Choose']='';
$lang['Pay']='';
$lang['Enjoy']='';
$lang['Find all restaurants available near you']='';
$lang['Browse hundreds of menus to find the food you like']='يمكنك تصفح مئات المتاجر والحصول علي منتجك المفضل';
$lang["It's quick, secure and easy"]='';
$lang['Food is prepared & delivered to your door']='سوف يتم تجهيز المنتجات وتوصيلها حتي باب منزلك';
$lang['Browse by cuisine']='تصفح بواسطة العلامات التجارية';
...
$lang['Restaurant List']='قائمة المتاجر';
$lang['No restaurant found']='لم يتم العثور علي أية متاجر';
...
$lang['Theme settings']='اعدادات القالب';
...
$lang['Search Results']='';
$lang['in your mobile']='';
$lang["Get our app, it's the fastest way to order food on the go"]='احصل علي التطبيق الخاص بنا، إنه الطريق الأسرع لطلب المنتجات علي الإطلاق';
...
$lang['Food Menu']='قائمة المنتجات';
$lang['Hide browse restaurant']='';
$lang['Hide restaurant signup']='إخفاء تسجيل المتاجر';
$lang['Top menu']='';
$lang['Select language']='';
$lang['receipt not available']='';
$lang['Restaurant menu']='قائمة المتجر';
...
$lang['Restaurant  by cuisine']='المتجر باستخدام العلامة التجارية';
$lang['Advance search options']='';
$lang['Disabled search by restaurant name']='ايقاف البحث باسم المتجر';
$lang['Disabled search by street name']='';
$lang['Disabled search by cuisine']='';
$lang['Disabled search by food name']='أيقاف البحث باستخدام اسم المنتج';
...
$lang['Note']='';
$lang['Restaurant Slug']='شعار الموقع';
...
$lang['Change sites']='';
$lang['enter restaurant name']='ادخل اسم المتجر';
...
$lang['Email Logs']='سجلات البريد اﻹلكتروني';
$lang['View Content']='';
...
$lang['Manage location']='ادارة المواقع';
$lang['Invoice']='الفواتير';
$lang['Email Settings']='اعدادات البريد الالكتروني';
$lang['Notification Template']=' قوالب اﻹشعارات ';
$lang['Notification Settings']='إعدادات اﻹشعارات';
$lang['Cron Jobs']='';
$lang['Add-ons']='اﻹضافات';
$lang['Export/Import']='إيراد \  استخراج';
$lang['MobileApp']='تطبيق الجوال';
$lang['Loyalty Points Program']='برنامج نقاط الولاء';
$lang['MerchantApp']='تطبيق المتجر';
$lang['Custom Code & Analytics']='الشفرات البرمجية و تحليلات جوجل';
$lang['Desktop Website logo']='';
...
$lang['Enabled Food name Search']='تفعيل البحث باستخدام المنتج';
$lang['Add space between price and currency']='';
$lang['Search by location']='';
$lang['User will search restaurant using location']='المستخدمون سيقومون بالبحث عن المتجر باستخدام الموقع';
$lang['Location search type']='';
$lang['Location Country']='';
$lang['City / Area']='';
$lang['State / City']='';
$lang['PostalCode/ZipCode']='';
$lang['Hide featured restaurant section']='أخفاء قسم المتاجر المميزة';
$lang['Hide language bar']='';
$lang['Featured Restaurant Sort']='ترتيب المتاجر المميزة';
$lang['Select options']='';
$lang['Random']='';
$lang['Sort by name']='';
...
$lang['Dine in']='';
$lang['Apply Tax to Food Item']='أَضافة ضريبة للمنتج';
...
$lang['Transaction']='';
$lang['Order food online from 1000+ restaurants!']='أطلب المنتجات أونلاين من أكثر من 1000+ متجر';
$lang["Food delivery service that's easy & convenient!"]='خدمة توصيل منتجات سهلة وبسيطة!';
$lang['District / Area']='';
...
$lang['Click here to update your merchant info']='انقر هنا لتحديث بيانات متاجرك';
