...
{	
    ...
    public function getAllCategories()
    {
		...
		$rows = array_column($rows, "category_name",  "cat_id");
		if ($rows) {
			return $rows;
		}
		return FALSE;
    }
    public function getCategoryList($merchant_id='999999')
	{
		$data_feed='';
    ...
    public function getAllSubcategories()
    {
		...
		$rows = array_column($rows, "subcategory_name",  "subcat_id");
		if ($rows) {
			return $rows;
		}
		return FALSE;
	...
	public function getAllBrands()
	{
		...
		$rows = array_column($rows, "brand_name",  "brand_id");
		if ($rows) {
			return $rows;
		}
		return FALSE;
	...
	public function merchantMenu()
	{
		...
		$payment_list=array('visible'=>$this->hasMerchantAccess("payment-gateway"),'tag'=>'payment-gateway','label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
              ...
              $fax_menu=array('visible'=>$this->hasMerchantAccess("fax"),
              				'tag'=>'fax',
              				'label'=>'<i class="fa fa-fax"></i>'.Yii::t("default",'Fax'),      
                   			'itemOptions'=>array('class'=>''), 'items'=>array(
                   
                   array('visible'=>$this->hasMerchantAccess("faxstats"),
                   		'tag'=>'faxstats', 'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Stats"),                    
                   		'url'=>array('merchant/faxstats')),                
                   
                   array('visible'=>$this->hasMerchantAccess("faxsettings"),
                   		'tag'=>'faxsettings', 
                   		'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Settings"),                    
                   		'url'=>array('merchant/faxsettings')),                
                   
                   array('visible'=>$this->hasMerchantAccess("faxpurchase"),
                   		'tag'=>'faxpurchase', 
                   		'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Purchase Fax Credit"),                    
                   		'url'=>array('merchant/faxpurchase')),                                 
                   
                   array('visible'=>$this->hasMerchantAccess("faxpurchasetrans"),
                   		'tag'=>'faxpurchasetrans', 
                   		'label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Purchase Credit Transactions"),                    
	...
	public function adminMenu()
	{
		return array(  
		    ...
		    'items'=>array(
                ...
                'tag'=>"merchant",'label'=>'<i class="fa fa-building"></i>'.Yii::t("default","Merchant List"),
                'url'=>array('/admin/merchant')),
                
                
                array('visible'=>$this->AA('sponsoredMerchantList'),
                'tag'=>"sponsoredMerchantList",
                'label'=>'<i class="fa fa-money"></i>'.Yii::t("default","Sponsored Listing"),                
                'url'=>array('/admin/sponsoredMerchantList')),
                
                array('visible'=>$this->AA('packages'),
                'tag'=>"packages",'label'=>'<i class="fa fa-archive"></i>'.Yii::t("default","Packages"),
                'url'=>array('/admin/packages')),                
                                
                array('visible'=>$this->AA('Cuisine'),
                'tag'=>"Cuisine",'label'=>'<i class="fa fa-bookmark"></i>'.Yii::t("default","Cuisine"),
                'url'=>array('/admin/Cuisine')),
                               
                array('visible'=>$this->AA('dishes'),
                'tag'=>"dishes",'label'=>'<i class="fa fa-cubes"></i>'.Yii::t("default","Products"),
                'url'=>array('/admin/dishes')),
                
                array('visible'=>true,
                'tag'=>"category",'label'=>'<i class="fa fa-sitemap"></i>'.Yii::t("default","Categories"),
                'url'=>array('/admin/category')),

                array('visible'=>true,
                'tag'=>"subcategory",'label'=>'<i class="fa fa-tags"></i>'.Yii::t("default","Sub Categories"),
                'url'=>array('/admin/subcategory')),

                array('visible'=>true,
                'tag'=>"brands",'label'=>'<i class="fa fa-ticket"></i>'.Yii::t("default","Brands"),
                'url'=>array('/admin/brands')),

                array('visible'=>$this->AA('OrderStatus'),
                'tag'=>"OrderStatus",'label'=>'<i class="fa fa-check-square"></i>'.Yii::t("default","Order Status"),
                'url'=>array('/admin/OrderStatus')),
                
                array('visible'=>$this->AA('incomingorders'),'tag'=>"incomingorders",
                'label'=>'<i class="fa fa-cart-arrow-down"></i>'.Yii::t("default","Incoming Orders"),
                'url'=>array('/admin/incomingorders')),           
                
                
                array('visible'=>$this->AA('settings'),
                'tag'=>"settings",'label'=>'<i class="fa fa-cogs"></i>'.Yii::t("default","Settings"),
                'url'=>array('/admin/settings')),       
                
                array('visible'=>$this->AA('themesettings'),
                'tag'=>"themesettings",'label'=>'<i class="fa fa-magic"></i>'.t("Theme settings"),
                ...
                'tag'=>"managelocation",'label'=>'<i class="fa fa-map-marker"></i>'.t("Manage location"),
                'url'=>array('/admin/managelocation')),
                                
                array('visible'=>$this->AA('commisionsettings'),
                'tag'=>"commisionsettings",
                'label'=>'<i class="fa fa-cc"></i>'.Yii::t("default","Commission Settings"),
                'url'=>array('/admin/commisionsettings')),                                   
                
                array('visible'=>$this->AA('voucher'),
                'tag'=>"voucher",
                'label'=>'<i class="fa fa-print"></i>'.Yii::t("default","Voucher"),
                'url'=>array('/admin/voucher')),                                   
                
                array('visible'=>$this->AA('invoice'),
                'tag'=>"invoice",
                'label'=>'<i class="fa fa-qrcode"></i>'.Yii::t("default","Invoice"),
                'url'=>array('/admin/invoice')),                                                   
                
                array('visible'=>$this->AA('merchantcommission'),
                'tag'=>"merchantcommission",
                'label'=>'<i class="fa fa-handshake-o  "></i>'.Yii::t("default","Merchant Commission"),
                ...
                'label'=>'<i class="fa fa-envelope-square"></i>'.Yii::t("default","Email Settings"),
                'url'=>array('/admin/emailsettings')),           
               
                array('visible'=>$this->AA('emailtpl'),
                'tag'=>"emailtpl",'label'=>'<i class="fa fa-book"></i>'.Yii::t("default","Notification Template"),
                'url'=>array('/admin/emailtpl')),           
                
                array('visible'=>$this->AA('notisettings'),
                'tag'=>"notisettings",'label'=>'<i class="fa fa-bell"></i>'.Yii::t("default","Notification Settings"),
                'url'=>array('/admin/notisettings')),            
                                
                array('visible'=>$this->AA('emailogs'),'tag'=>"emailogs",
                'label'=>'<i class="fa fa-inbox"></i>'.Yii::t("default","Email Logs"),
                'url'=>array('/admin/emailogs')),           
                
                array('visible'=>$this->AA('cronjobs'),'tag'=>"cronjobs",
                'label'=>'<i class="fa fa-server"></i>'.Yii::t("default","Cron Jobs"),
                ...
                'tag'=>"customPage",'label'=>'<i class="fa fa-laptop"></i>'.Yii::t("default","Custom Page"),
                ...
                'label'=>'<i class="fa fa-address-book "></i>'.Yii::t("default","Contact Settings"),
                'url'=>array('/admin/ContactSettings')),                
                
                array('visible'=>$this->AA('SocialSettings'),'tag'=>"SocialSettings",
                'label'=>'<i class="fa fa-globe"></i>'.Yii::t("default","Social Settings"),
                ...
                'label'=>'<i class="fa fa-language"></i>'.Yii::t("default","Manage Language"),
                'url'=>array('/admin/ManageLanguage')),

                array('visible'=>$this->AA('Seo'),
                'tag'=>"Seo",'label'=>'<i class="fa fa-line-chart "></i>'.Yii::t("default","SEO"),
                'url'=>array('/admin/Seo')),   
                
                
                /**add ons */
                array('visible'=>$this->AA('addons'),'tag'=>'addons',
                'label'=>'<i class="fa fa-puzzle-piece"></i>'.Yii::t("default",'Add-ons'),
                   'itemOptions'=>array('class'=>''), 'items'=>array(                   
                ...
                'tag'=>"analytics",'label'=>'<i class="fa fa-code"></i>'.Yii::t("default","Custom Code & Analytics"),
                'url'=>array('/admin/analytics')),                               
                
                array('visible'=>$this->AA('customerlist'),'tag'=>"customerlist",
                'label'=>'<i class="fa fa-users"></i>'.Yii::t("default","Customer List"),
                'url'=>array('/admin/customerlist')),                               
                
                array('visible'=>$this->AA('subscriberlist'),'tag'=>"subscriberlist",
                'label'=>'<i class="fa fa-hand-pointer-o"></i>'.Yii::t("default","Subscriber List"),
                ...
                'label'=>'<i class="fa fa-usd"></i>'.Yii::t("default",'Payment Gateway'),
                 ...
                 'tag'=>'sms','label'=>'<i class="fa fa-envelope-open-o "></i>'.Yii::t("default",'SMS'),
                   'itemOptions'=>array('class'=>''), 'items'=>array(
                ...
                'tag'=>'reports','label'=>'<i class="fa fa-file-text-o"></i>'.Yii::t("default",'Reports'),
                   'itemOptions'=>array('class'=>''), 'items'=>array(
                 ...
                 'tag'=>"userList",'label'=>'<i class="fa fa-user"></i>'.Yii::t("default","User List"),
    ...
    public function currencyForDropDown()
    {
    	$data_feed='';
		$stmt="
		SELECT * FROM
...
'sub_item_name',$addon_name_trans).'</div>';
		       ...
		       if ($receipt){		       	  
		       	  $item_array_total['voucher_value']=$data['voucher_amount'];
		       	  $item_array_total['voucher_types']=$data['voucher_type'];
		       }
